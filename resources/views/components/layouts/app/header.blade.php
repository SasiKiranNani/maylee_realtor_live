    ...
    <header id="main-header" class="main-header <?php echo $header_type; ?> w-100">
        ...
        <nav class="navbar navbar-expand-xl navbar-dark sticky-header z-10">
            <div
                class="container d-flex align-items-center align-items-lg-start justify-content-lg-between gap-5 position-relative">
                <a href="{{ route('home') }}" class="navbar-brand align-items-center mb-md-0 text-decoration-none">
                    <img src="{{ asset('frontend/assets/images/maylee-realtor-logo-v2.png') }}" alt="logo"
                ...
                <div class="pull-right d-flex align-items-center mt-0 mt-lg-3 gap-2 gap-md-5">
                    <!-- Call button -->
                    <a href="#" class="rt-btn btn-pink btn-outline call-btn">(001) - 2345678901 <span
                    ...
                    @if (Auth::check())
                        ...
                        <div class="rt-user-nav-widget">
                            <div class="toggle-btn">
                                <img src="{{ asset('frontend/assets/images/user.webp') }}">
                            </div>
