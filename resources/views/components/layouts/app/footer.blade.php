    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="rt-footer-about-widget">
                        <img src="{{ asset('frontend/assets/images/maylee-realtor-logo-v2.png') }}"
        ...
        <div class="footer-bottom position-relative">
            <div class="rt-disclaimer-wrap d-block pb-4">
                <p class="mb-0">Copyright 2025 All rights reserved. Toronto Real Estate Board (TREB) assumes no
