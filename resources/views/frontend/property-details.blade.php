                                        ...
                                        @foreach ($property['MediaURLs'] as $mediaUrl)
                                            <div class="swiper-slide">
                                                @if (!empty($mediaUrl) && filter_var($mediaUrl, FILTER_VALIDATE_URL))
                                                    <img src="{{ $mediaUrl }}" alt="Property Image"
                                    ...
                                    <div class="swiper rt-single-property-gallery-thumbs-slider">
                                        <div class="swiper-wrapper">
                                            @foreach ($property['MediaURLs'] as $mediaUrl)
                                                <div class="swiper-slide">
                                                    @if (!empty($mediaUrl) && filter_var($mediaUrl, FILTER_VALIDATE_URL))
                                                        <img src="{{ $mediaUrl }}" alt="Property thumbnail {{ $loop->iteration }}"
                                                            onerror="this.src='{{ asset('frontend/assets/images/properties/property-1.jpg') }}'">
                                                    @else
                                                        <div class="media-placeholder">
                                                            <i class="fa-solid fa-camera"></i>
                            ...
                            <div class="box-content">
                                <div class="amenities-card">
                                    ...
                                    <div class="amenities-map-panel">
                                        <div id="amenitiesMap" data-lat="{{ $property['Latitude'] ?? 43.6532 }}"
                            ...
                            <div class="rt-book-tour-widget rt-property-side-widget">
                                ...
                                <div class="widget-body">
                                    <form action="{{ route('tour-bookings.store') }}" method="POST" id="tour-request-form">
                                        @csrf
                                        <input type="hidden" name="listing_key" value="{{ $property['ListingKey'] ?? '' }}">
                                        ...
                                        <div class="form-group d-block w-100">
                                            <input type="text" name="phone" id="reqt-phone" placeholder="Enter Phone No"
                                        ...
                                        <div class="form-group d-block w-100">
                                            <label for="reqt-consent" class="rt-checkbox">
                                                <input class="rt_checkbox_input" type="checkbox" id="reqt-consent"
                                                    name="consent" value="1" {{ old('consent') ? 'checked' : '' }} required>
                                    ...
                                    <div class="rt-mortgage-calculator">
                                        ...
                                        <div class="rt-mortgage-disclaimer">
                                            ...
                                            <div class="rt-disclaimer-content">
                                                ...
                                                <p>Our mortgage calculator provides approximate estimates based solely on the
                                                    information you enter, designed for illustrative purposes to help you
                                                    explore options. These results do not constitute personalized financial
                                                    advice, and May Lee makes no representations or warranties regarding their
                                                    accuracy or completeness.</p>
                                                <h5>Key Assumptions</h5>
                                                <p>Calculations presume timely payments, a fixed interest rate throughout the
                                                    amortization period (though rates may fluctuate in reality), and no changes
                                                    to your financial situation. Opting for accelerated weekly or bi-weekly
                                                    payments effectively adds one extra monthly payment annually, potentially
                                                    shortening your amortization—subject to lender terms and conditions.</p>
                                                <h5>Prepayment and Insurance Notes</h5>
                                                <p>Prepayment privileges differ by lender; please review your mortgage documents
                                                    for specifics, especially if switching providers. This tool does not provide
                                                    binding quotes. Mortgage insurance estimates are illustrative only, varying
                                                    by age, number of borrowers, coverage type, and provincial taxes—eligibility
                                                    criteria apply.</p>
                                                <h5>Your Next Steps</h5>
                                                <p>For tailored guidance and peace of mind, we encourage consulting a licensed
                                                    mortgage professional or certified financial advisor to ensure decisions
                                                    align with your unique needs and protect your financial security. Your trust
                                                    matters to us.</p>
                                            </div>
                                        </div>
                        ...
                        <div class="container">
                                                    ...
                                                    <div class="rt-property-body">
                                                        ...
                                                        <div class="property-meta">
                                                            <ul class="aminity-list">
                                                                ...
                                                                <li class="aminity-item">
                                                                    <img
                                                                        src="{{ asset('frontend/assets/images/icons/clock.svg') }}">
                                                                    <span>
                            ...
                            @else
                                <div class="no-related-properties text-center py-5">
                                    <p class="text-muted">No similar properties found in {{ $property['City'] }} within the
                                        price
